...
public class QUserCoupon extends EntityPathBase<UserCoupon> {
    ...
    private static final long serialVersionUID = 1327301286L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QUserCoupon userCoupon = new QUserCoupon("userCoupon");

    public final com.example.ticketing.model.coupon.QCouponTemplate couponTemplate;
    ...
    public final EnumPath<com.example.ticketing.model.coupon.CouponStatus> status = createEnum("status", com.example.ticketing.model.coupon.CouponStatus.class);
    ...
    public QUserCoupon(Class<? extends UserCoupon> type, PathMetadata metadata, PathInits inits) {
        ...
        this.couponTemplate = inits.isInitialized("couponTemplate") ? new com.example.ticketing.model.coupon.QCouponTemplate(forProperty("couponTemplate"), inits.get("couponTemplate")) : null;
